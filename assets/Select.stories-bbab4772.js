import{b as I,d as u,c as d,e as m,f as t,F as M,g as W,n as g,o as p,t as C,p as N,h as A}from"./vue.esm-bundler-3c0112f6.js";import{_ as E}from"./_plugin-vue_export-helper-c27b6911.js";import{B as L}from"./BaseField-c2148026.js";const P=e=>(N("data-v-ce7705bf"),e=e(),A(),e),R=["value"],z=["onMousedown"],D=P(()=>m("i",{class:"down fas fa-chevron-down"},null,-1)),k={__name:"BaseSelect",props:{options:{type:Array,default:()=>[]},modelValue:{type:String,default:""},placeholder:{type:String,default:""}},emits:["update:modelValue","change"],setup(e,{emit:a}){const l=e,f=I(),F=()=>{f.value.focus()},o=u({get:()=>l.modelValue,set:s=>{a("update:modelValue",s),a("change",s)}}),w=u(()=>{var s;return(s=l.options.find(_=>_.value===o.value))==null?void 0:s.label}),v=u(()=>o.value==="");return(s,_)=>(p(),d("div",{class:g(["base-select",{selected:!t(v)}]),onClick:F},[m("input",{ref_key:"inputRef",ref:f,type:"text",value:t(v)?e.placeholder:t(w),readonly:""},null,8,R),m("ul",null,[(p(!0),d(M,null,W(e.options,(c,x)=>(p(),d("li",{key:x,class:g({checked:c.value===t(o)}),onMousedown:O=>o.value=c.value},C(c.label),43,z))),128))]),D],2))}},i=E(k,[["__scopeId","data-v-ce7705bf"]]);k.__docgenInfo={exportName:"default",displayName:"BaseSelect",description:"",tags:{},props:[{name:"options",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"modelValue",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],events:[{name:"update:modelValue"},{name:"change"}],sourceFiles:["/home/runner/work/uibook/uibook/src/components/form/BaseSelect.vue"]};const G={title:"Base/Select",component:i,tags:["autodocs"],args:{placeholder:"請輸入",options:[{label:"選項1",value:"1"},{label:"選項2",value:"2"},{label:"選項3",value:"3"}]},render:(e,{vModel:a})=>({components:{BaseSelect:i},setup(){const l=a("modelValue");return{args:e,modelValue:l}},template:`
...
//# sourceMappingURL=Select.stories-bbab4772.js.map
