import{B as T}from"./BaseTooltip-91226319.js";import{r as f,c as v,a as g,d as V,u as n,g as $,h as E,f as L,n as S,o as u,F as O,j,p as q,k as G,t as H}from"./vue.esm-bundler-a711ab6d.js";import{_ as J}from"./_plugin-vue_export-helper-c27b6911.js";import{B as K}from"./BaseField-850dee9b.js";const P=e=>(q("data-v-f60a7443"),e=e(),G(),e),Q=["value"],U=P(()=>V("i",{class:"down fas fa-chevron-down"},null,-1)),X=["onMousedown"],N={__name:"BaseSelectMultiple",props:{options:{type:Array,default:()=>[]},modelValue:{type:Array,default:()=>[]},placeholder:{type:String,default:""},small:{type:Boolean,default:!1},large:{type:Boolean,default:!1}},emits:["update:modelValue","change"],setup(e,{emit:a}){const t=e,B=f(),R=()=>{B.value.focus()},s=v({get:()=>t.modelValue,set:l=>{a("update:modelValue",l),a("change",l)}}),W=v(()=>t.options.filter(l=>s.value.includes(l.value)).map(l=>l.label)),b=v(()=>s.value.length===0),z=l=>{const o=s.value.indexOf(l.value);if(o>=0){s.value.splice(o,1);return}s.value=[...s.value,l.value]},i=f(!1),y=f();return(l,o)=>{const A=T;return u(),g("div",{ref_key:"buttonRef",ref:y,class:S(["base-select",{"base-select":!0,"base-select--small":e.small,"base-select--large":e.large,selected:!n(b)}]),onClick:R},[V("input",{ref_key:"inputRef",ref:B,type:"text",value:n(b)?e.placeholder:n(W),readonly:"",onFocus:o[0]||(o[0]=r=>i.value=!0),onBlur:o[1]||(o[1]=r=>i.value=!1)},null,40,Q),U,n(i)?(u(),$(A,{key:0,reference:n(y),full:""},{default:E(()=>[V("ul",null,[(u(!0),g(O,null,j(e.options,(r,D)=>(u(),g("li",{key:D,class:S({checked:n(s).includes(r.value)}),onMousedown:Y=>z(r)},H(r.label),43,X))),128))])]),_:1},8,["reference"])):L("",!0)],2)}}},m=J(N,[["__scopeId","data-v-f60a7443"]]);N.__docgenInfo={exportName:"default",displayName:"BaseSelectMultiple",description:"",tags:{},props:[{name:"options",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"modelValue",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"small",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"large",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"update:modelValue"},{name:"change"}],sourceFiles:["/home/runner/work/uibook/uibook/src/components/base/BaseSelectMultiple.vue"]};const te={component:m,decorators:[e=>({components:{story:e},template:`
...
//# sourceMappingURL=SelectMultiple.stories-0c34085f.js.map
