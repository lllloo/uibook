import{_ as L}from"./BaseTooltip-efb5cec6.js";import{_ as O}from"./IconAngleDown-3fe7d2ce.js";import{r as b,k as v,c as f,a as B,m as r,C as R,y as T,z as j,g as q,n as y,o as u,F as G,D as H,t as J}from"./vue.esm-bundler-2ef2e216.js";import{_ as K}from"./_plugin-vue_export-helper-c27b6911.js";import{B as P}from"./BaseField-083923c6.js";const Q=["value","placeholder","disabled"],U=["onMousedown"],N={__name:"BaseSelectMultiple",props:{options:{type:Array,default:()=>[]},modelValue:{type:Array,default:()=>[]},placeholder:{type:String,default:""},disabled:{type:Boolean,default:!1}},emits:["update:modelValue","change"],setup(e,{emit:t}){const a=e,g=b(),z=()=>{g.value.focus()},V=t,o=v({get:()=>a.modelValue,set:l=>{V("update:modelValue",l),V("change",l)}}),A=v(()=>a.options.filter(l=>o.value.includes(l.value)).map(l=>l.label)),_=v(()=>o.value.length===0?"":!1),I=l=>{const n=o.value.indexOf(l.value);if(n>=0){o.value.splice(n,1);return}o.value=[...o.value,l.value]},i=b(!1);return(l,n)=>{const W=O,$=L;return u(),f("div",{class:y(["base-select",{selected:!r(_),"is-disabled":e.disabled}]),onClick:z},[B("input",{ref_key:"inputRef",ref:g,type:"text",value:r(_)?null:r(A),placeholder:e.placeholder,readonly:"",disabled:e.disabled,onFocus:n[0]||(n[0]=s=>i.value=!0),onBlur:n[1]||(n[1]=s=>i.value=!1)},null,40,Q),R(W,{class:"down"}),r(i)?(u(),T($,{key:0,full:""},{default:j(()=>[B("ul",null,[(u(!0),f(G,null,H(e.options,(s,E)=>(u(),f("li",{key:E,class:y({checked:r(o).includes(s.value)}),onMousedown:X=>I(s)},J(s.label),43,U))),128))])]),_:1})):q("",!0)],2)}}},p=K(N,[["__scopeId","data-v-d350008e"]]);N.__docgenInfo={exportName:"default",displayName:"BaseSelectMultiple",description:"",tags:{},props:[{name:"options",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"modelValue",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"update:modelValue"},{name:"change"}],sourceFiles:["/home/runner/work/uibook/uibook/src/components/base/BaseSelectMultiple.vue"]};const te={component:p,decorators:[e=>({components:{story:e},template:`
...
}`,...(D=(C=m.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};const oe=["Default","Size","WithWrap"];export{d as Default,c as Size,m as WithWrap,oe as __namedExportsOrder,te as default};
